        ...
        <div class="flex flex-col gap-4 w-full">
            ...
            <div class="flex flex-row justify-between items-center">
                <div class="flex flex-col gap-2 justify-center items-center">
                    ...
                    <p class="max-md:text-xs font-medium">Order Created</p>
                </div>
                <div class="flex flex-col gap-2 justify-center items-center">
                    <div class="bg-primary p-2 rounded-md w-min hover:-translate-y-2 duration-150 transition-transform">
                        <div class="rounded-full p-1 flex justify-center items-center bg-white">
                    ...
                    <p class="max-md:text-xs font-medium">Order Paided</p>
                </div>
                <div class="flex flex-col gap-2 justify-center items-center">
                    <div class="bg-primary p-2 rounded-md w-min hover:-translate-y-2 duration-150 transition-transform">
                        <div class="rounded-full p-1 flex justify-center items-center bg-white">
                    ...
                    <p class="max-md:text-xs font-medium">Order Processed</p>
                </div>
                <div class="flex flex-col gap-2 justify-center items-center">
                    <div class="bg-primary p-2 rounded-md w-min hover:-translate-y-2 duration-150 transition-transform">
                        <div class="rounded-full p-1 flex justify-center items-center bg-white">
                    ...
                    <p class="max-md:text-xs font-medium">Order Shipped</p>
                </div>
            </div>
        </div>
    </div>
